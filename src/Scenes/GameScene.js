  ...
  // }
    ...
    addMountains(){
        ...
        if(rightmostMountain < gameConfig.width * 2){
            let mountain = this.physics.add.sprite(rightmostMountain + Phaser.Math.Between(100, 350), gameConfig.height + Phaser.Math.Between(0, 100), "mountain");
    ...
    update(){
        ...
        this.platformGroup.getChildren().forEach(function(platform){
            let platformDistance = gameConfig.width - platform.x - platform.displayWidth / 2;
        ...
        if(minDistance > this.nextPlatformDistance){
            ...
            let minPlatformHeight = gameConfig.height * gameOptions.platformVerticalLimit[0];
            let maxPlatformHeight = gameConfig.height * gameOptions.platformVerticalLimit[1];
